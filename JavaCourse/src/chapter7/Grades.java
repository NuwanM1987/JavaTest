...
public class Grades {
	...
	private static Scanner scanner = new Scanner(System.in);
	 ...
	 //allow them to enter the grades.
	 public static void getGrades(){
		 //we have an empty array, we have no values, and we want to increment the counter.
	 ...
	 public static int calculateSum(){
		 int sum =0;
		 //we do have values inside of our array, so it makes sense to use the enhanced for loop this time.
